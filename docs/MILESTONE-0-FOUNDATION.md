...
**Entregables:** `apps/web` con Next.js + TypeScript + Tailwind + shadcn/ui; layout inicial de Proof of Work; cliente/configuración de Convex preparada para suscripciones.
